...
class ControllerPaymentBillplz extends Controller {
	...
	public function index() {
		...
		$data['entry_notifycust'] = $this->language->get('entry_notifycust');
		...
		$data['help_notifycust'] = $this->language->get('help_notifycust');
		...
		if (isset($this->request->post['billplz_notifycust'])) {
			$data['billplz_notifycust'] = $this->request->post['billplz_notifycust'];
		} else {
			$data['billplz_notifycust'] = $this->config->get('billplz_notifycust');
		}
